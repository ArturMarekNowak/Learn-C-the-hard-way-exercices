...
void Person_destroy(struct Person *who)
{
	...
	//Task three: remove free(who->name)
	free(who->name);
	free(who);
}
...
int main(int argc, char *argv[])
{
	...
	//Task one: Pass Null to Person_destroy
	//Person_destroy(NULL);
	
	//Task two: forget about Person_destroy and check the debbbuger
	Person_destroy(joe);
